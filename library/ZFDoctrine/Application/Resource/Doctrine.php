    ...
    protected function _getCache(array $options)
    {
        ...
        switch ($options['driver'])
        {
            ...
            case 'memcache':
				...
				$driver = new Doctrine_Cache_Memcache($options['options']);
				Doctrine_Manager::getInstance()->setAttribute(Doctrine::ATTR_QUERY_CACHE, $driver);
				Doctrine_Manager::getInstance()->setAttribute(Doctrine::ATTR_RESULT_CACHE, $driver);
				return $driver;
