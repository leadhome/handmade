...
class pEngine_Category_Form_MoveCategory extends Zend_Form
{
    public function init()
    {
        $categories = Spravka_Model_CategoryTable::getInstance()->getCategories();
		if($categories){
			...
			$to_category->addMultiOption(1, ' КОРЕНЬ');
			foreach($categories as $c)
