...
class ZendX_JQuery_JqGrid_Column_Decorator_Link extends ZendX_JQuery_JqGrid_Column_Decorator_Abstract
{
    ...
    public function decorate()
    {
        if (! isset($this->_options['link'])) {
            throw new ZendX_JQuery_JqGrid_Exception('A valid link must be supplied.');
        }
