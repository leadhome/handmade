...
abstract class ZendX_JQuery_JqGrid_Column_Decorator_Abstract
{
    /**
     * Column Instance
     * 
     * @var $_column ZendX_JQuery_JqGrid_Column
     */
    protected $_column;

    public function __construct(ZendX_JQuery_JqGrid_Column $column)
    {
        $this->_column = $column;
    }
     ...
     * 
     * @return ZendX_JQuery_JqGrid_Column
     */
