...
return array(
    ...
    "Value is required and can't be empty" => "Вы не заполнили данное поле",
    ...
    "Invalid type given, value should be a string" => "Недопустимый тип данных, значение должно быть строкой",
    "'%value%' is less than %min% characters long" => "разрешенная минимальная длина в %min% символов",
    "'%value%' is more than %max% characters long" => "разрешенная максимальная длина в %max% символов",
);
